  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved time_sheet as @time_sheet" do
        ...
        post :create, {:time_sheet => {}}, valid_session
        assigns(:time_sheet).should be_a_new(TimeSheet)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested time_sheet" do
        ...
        put :update, {:id => time_sheet.to_param, :time_sheet => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the time_sheet as @time_sheet" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TimeSheet.any_instance.stub(:save).and_return(false)
        put :update, {:id => time_sheet.to_param, :time_sheet => {}}, valid_session
        assigns(:time_sheet).should eq(time_sheet)
      end
